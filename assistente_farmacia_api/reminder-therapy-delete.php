...
$deleted = delete_reminder_therapy( $reminder_id, $user['id'] );

// Se l'eliminazione è riuscita e c'è un file associato, eliminalo
if( $deleted && $existing_reminder['file'] ){
...
echo json_encode([
	'code'    => 200,
	'status'  => true,
	'message' => 'Promemoria terapia eliminato con successo',
]); 